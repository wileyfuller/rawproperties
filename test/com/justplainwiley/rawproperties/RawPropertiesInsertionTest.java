 ...
 * @author wiley
 */
public class RawPropertiesInsertionTest {

    private RawProperties rawProps;

    public RawPropertiesInsertionTest() {
    }
    ...
    @Test
    public void insertionAtComment() throws IOException {
        ...
        try {
            ...
            Logger.getLogger(RawPropertiesInsertionTest.class.getName()).log(Level.SEVERE, null, ex);
        ...
        RawEntry insertedEntry = new RawEntry();
        insertedEntry.setKey("newly.inserted");
        insertedEntry.addLine("property");
        insertedEntry.setType(EntryType.PROPERTY);
        rawProps.insertEntry(4, insertedEntry);
        ...
        RawEntry entry = rawProps.getEntry("newly.inserted");
        assertNotNull(entry);
        assertEquals("property", entry.getValue());
